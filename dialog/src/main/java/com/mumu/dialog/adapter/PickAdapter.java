 ...
 * desc    :
 */
public class PickAdapter extends BaseQuickAdapter<PickEntity.RestbodyBean.HigherLevelBean, BaseViewHolder> {

    public PickAdapter(@Nullable List data) {
        super(R.layout.item_pick, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, PickEntity.RestbodyBean.HigherLevelBean data) {
        //将每一个需要赋值的id和对应的数据绑定
